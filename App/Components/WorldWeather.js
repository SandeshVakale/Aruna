...
import WorldWeatherCallout from './WorldWeatherCallout'
import Styles from './Styles/WorldWeatherStyles'
...
class WorldWeather extends React.Component {
  /* ***********************************************************
  ...
  *************************************************************/
  ...
  renderMapMarkers (location) {
    ...
    * Customize the callout in ./WorldWeatherCallout.js
    *************************************************************/

    return (
      <MapView.Marker key={location.title} coordinate={{latitude: location.latitude, longitude: location.longitude}}>
        <WorldWeatherCallout location={location} onPress={this.calloutPress} />
      </MapView.Marker>
    )
  }
